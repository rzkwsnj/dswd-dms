...
class RegionResource extends Resource implements HasShieldPermissions
{
    ...
    protected static ?string $slug = 'master-data/regions';
        ...
        return $form
            ->schema([
                Forms\Components\Section::make()
                    ...
                    ->columnSpan(['lg' => fn (?Region $record) => $record === null ? 3 : 2]),
                Forms\Components\Section::make()
                    ->schema([
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\DeleteAction::make()
                    ...
                    ->action(fn (Region $record) => $record->citizens()->count() > 0 ? Notification::make()->title('There is a citizen relationship, please delete the related data first!')->warning()->send() : $record->delete()),
            ])
            ->groupedBulkActions([
